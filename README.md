...
| `cmaq_jax.config` | `GridConfig`, `PPMConstants` — every constant traced to its Fortran line | A0.2 | not started |
| Fortran golden harness | compile `hppm.F`/`vppm.F` unmodified, emit reference arrays | A0.3–A0.4 | not started |
