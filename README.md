...
| `cmaq_jax.vadv` | column solve + flux-matching velocity adjustment | A2.2–A2.3 | alpha |
| `cmaq_jax.vadv` | flux/velocity diagnosis, CFL sub-stepping | A2.1, A2.4 | not started |
